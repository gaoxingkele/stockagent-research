...
## 2026-06-07 EXPC done -- C6 positioned vs existing info-theory framings
src/bench/run_expc.py: NMI (FIT 2511.16339) + permutation (Conditional P-threshold MI 2601.00395) baseline on the MI3 top-6 hits, vs our interaction info. RESULT: marginal NMI 0.0004-0.0009 (max 0.0009 << FIT's 0.05 efficient-market band), conditional NMI 0.0016-0.0032; our II +0.0020..+0.0048, 6/6 positive at p<0.05. VERDICT: NMI/conditional-MI baselines see near-zero marginal dependence and would call this 'efficient market'; only our Z-label-permutation interaction info isolates the regime-ADDED information. Confirms C6's method is the distinguishing contribution among finance info-theory framings. Next: BSYN synthesis.

## 2026-06-07 BSYN done -- benchmark synthesis (REGIME-BASELINE-BENCH COMPLETE)
src/bench/summarize_bench.py -> results/bench/{summary.md,bench_verdict.json} + paper/sections/figures/bench_summary.png.
OVERALL VERDICT: NONE of the reimplemented 2025-26 SOTA baselines survive our honest protocol. EXP-A Regime-Aware LightGBM (incl rolling-HMM) SUB-COST (HMM Sharpe = cash-vol-reduction artifact, mean CI touches 0); EXP-B When-Alpha-Breaks abstention does NOT rescue (all net-negative); EXP-C NMI/conditional-MI framings see an efficient-market band (max marginal NMI 0.0009<0.05) while our interaction info isolates regime-added info 6/6. Like our own onset/motif signals, the closest SOTA is sub-cost; apparent regime Sharpe gains are timing/risk-reduction not net-of-cost alpha. Strengthens the honest-findings thesis + positions C6 interaction-information as the distinguishing method. All reported with raw Sharpe + Deflated Sharpe + date-clustered CI (SIGN-B1). REGIME-BASELINE-BENCH BACKLOG COMPLETE.
