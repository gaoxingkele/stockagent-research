...
This paper makes four contributions. The core novelty is methodological — the knowledge-encoding procedure (C1) and the V12-Agentic framework anchored to a real deployed system (C2); C3–C4 are honest, deployment-realistic empirical findings rather than new techniques.
